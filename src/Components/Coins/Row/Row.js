...
const Row = (props) => {
  const {id, symbol, name, image, current_price:price, price_change_percentage_24h: change24h,high_24h, low_24h, market_cap_rank, market_cap : marketCap, total_volume: volume24h   } = props.coinInfo;
  return (
    <tr>
