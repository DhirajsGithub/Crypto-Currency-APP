...
const Coin = (props) => {
  ...
  let fully_diluted_valuation = Intlfunc(props.marketData?.fully_diluted_valuation[currency])
  ...
  return (
    <div className={classes.main}>
      ...
      <div className={classes.coinNumbers}>
        <p>Market Cap: <span>{symbol} {marketCap}</span> </p> &nbsp; &nbsp; 
      ...
      <div className={classes.coinNumbers}>
        <p>Fully Diluted Valuation: <span>{symbol} {fully_diluted_valuation}</span> </p> &nbsp; &nbsp; 
        <p>Max Supply: <span>$ {max_supply}</span></p>
      </div>
      <div className={classes.coinNumbers}>
        <p>Total Volume: <span>{symbol} {total_volume}</span> </p> &nbsp; &nbsp; 
      </div>
      <div className={classes.coinNumbers}>
        <p>High 24H: <span>{symbol} {high_24h}</span> </p> &nbsp; &nbsp; 
        <p>Low 24H: <span>{symbol} {low_24h}</span></p>
      </div>
